...
public class VentaMercaderias extends Asiento {
	...
	public VentaMercaderias(Calendar f, double[] i, boolean enunciadoCuentas) {
		...
		String enunciado1 = " La empresa efectúa una venta de mercaderías por importe de " +inputs[0]+ "€ más un " +Main.IVA+ "% de IVA. " 
		...
		dameCuenta(430).añadirDebe(new Anotacion(fecha, "Clientes mercaderías", inputs[0]*(1+Main.IVA/100), damePrioridad(430)));
