package es.ubu.inf.tfg.otrosCalculos;
...
public class Calculos extends Asiento{
	public int ano;
	static double rentEconomica;
	static double rentFinanciera;
	static double fondoManiobra;
	static double ratioLiquidez;
	static double ratioTesoreria;
	static double ratioEndeudamiento;
	static double ratioAutonomia;
	static double ratioCalidad;
	static Calendar fecha;
	
	static double activoAnoAnterior;
	static double pnAnoAnterior;
